...
public class DVMarginChecksScenario2 extends TestBase {
	
	@Test(dataProvider="getData16")
	public void dVMarginChecksScenario2 (String lemailid18, String lpassword18, String lemailid19, String lpassword19, String lemailid20, String lpassword20) throws InterruptedException {
		
		driver.get(config.getProperty("dashtestsiteurl"));
		log.debug("Navigated To: "+config.getProperty("dashtestsiteurl"));
		test.log(LogStatus.INFO, "Start DSR - Margin Checks - Scenario 2: Product(3) - Margin Increased & Reset + Decreased & Reset + No Change");
		driver.manage().timeouts().implicitlyWait(Integer.parseInt(config.getProperty("implict.wait")),TimeUnit.SECONDS);
		
		//login
		type("DashLoginEmailInputText2_XPATH",lemailid18);
		driver.findElement(By.xpath(OR.getProperty("DashLoginPasswordInput2_XPATH"))).sendKeys(lpassword18);
		...
		//Reset Price
		click("ResetPrice1_XPATH");
		Thread.sleep(3000);
		
		click("ResetPriceBTN_CSS");
		Thread.sleep(2000);
		...
		type("emailid_XPATH",lemailid19);
		driver.findElement(By.xpath(OR.getProperty("password_XPATH"))).sendKeys(lpassword19);
		test.log(LogStatus.INFO, "Entering Password.. ");
		click("login_XPATH");
		Thread.sleep(2000);
		...
		type("iemailid_XPATH",lemailid20);
		driver.findElement(By.xpath(OR.getProperty("ipassword_XPATH"))).sendKeys(lpassword20);
		test.log(LogStatus.INFO, "Entering Password.. ");
		click("ilogin_XPATH");
		Thread.sleep(2000);
	...
	public Object[][] getData16(){
		...
		String sheetName ="DVMarginChecksScenario2";
