...
public class DVMarginChecksScenario6 extends TestBase {
	
	@Test(dataProvider="getData20")
	public void dVMarginChecksScenario6 (String lemailid22, String lpassword22, String lemailid23, String lpassword23, String lemailid24, String lpassword24) throws InterruptedException {
		
		driver.get(config.getProperty("dashtestsiteurl"));
		log.debug("Navigated To: "+config.getProperty("dashtestsiteurl"));
		test.log(LogStatus.INFO, "Start DSR - Margin Checks - Scenario 6: Product(3) - Products with mutiple units - Second unit - Margin Increased+Decreased+No Change");
		...
		//Change the unit for Product 1
		click("UnitChange1_XPATH");
		Thread.sleep(2000);
		click("UnitSelect1_XPATH");
		Thread.sleep(2000);
		
		//Increase Margin
		type("CartProductMarginEdit_XPATH","25");
		Thread.sleep(5000);
		
		//Change the unit for Product 2
		click("UnitChange2_XPATH");
		Thread.sleep(2000);
		click("UnitSelect2_XPATH");
		Thread.sleep(2000);
		...
		//Change the unit for Product 3
		click("UnitChange3_XPATH");
		Thread.sleep(2000);
		click("UnitSelect3_XPATH");
		Thread.sleep(2000);
	...
	public Object[][] getData20(){
		...
		String sheetName ="DVMarginChecksScenario6";
